...
namespace ClaimParser.App
{
    internal class Program
    {
        private static readonly string claimText = @"1. A product tag system, comprising:
...
29.The method of claim 20, further comprising the step of writing to said tag, at said point of sale, information regarding said sale of said product, whereby said product sale information is available for subsequent use.";
        ...
        {
            var responseService = new ClaimResponseService(new ClaimParserService());

            var response = responseService.GenerateClaimResponse(claimText);
